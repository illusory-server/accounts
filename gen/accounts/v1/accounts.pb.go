...
var file_accounts_v1_accounts_proto_rawDesc = []byte{
	...
	0x63, 0x6f, 0x75, 0x6e, 0x74, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x02, 0x76, 0x31,
	0x22, 0x07, 0x0a, 0x05, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x22, 0x35, 0x0a, 0x05, 0x45, 0x72, 0x72,
	...
	0x28, 0x09, 0x52, 0x02, 0x49, 0x64, 0x22, 0x21, 0x0a, 0x0f, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e,
	0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x0e, 0x0a, 0x02, 0x49, 0x64, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x49, 0x64, 0x32, 0x42, 0x0a, 0x0f, 0x41, 0x63, 0x63,
	0x6f, 0x75, 0x6e, 0x74, 0x73, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x2f, 0x0a, 0x0e,
	0x47, 0x65, 0x74, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x42, 0x79, 0x49, 0x64, 0x12, 0x06,
	0x2e, 0x76, 0x31, 0x2e, 0x49, 0x64, 0x1a, 0x13, 0x2e, 0x76, 0x31, 0x2e, 0x41, 0x63, 0x63, 0x6f,
	0x75, 0x6e, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x41, 0x5a,
...
var file_accounts_v1_accounts_proto_goTypes = []any{
	...
	(*Id)(nil),              // 2: v1.Id
	(*AccountResponse)(nil), // 3: v1.AccountResponse
}
var file_accounts_v1_accounts_proto_depIdxs = []int32{
	2, // 0: v1.AccountsService.GetAccountById:input_type -> v1.Id
	3, // 1: v1.AccountsService.GetAccountById:output_type -> v1.AccountResponse
...
func file_accounts_v1_accounts_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_accounts_v1_accounts_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Empty); i {
			case 0:
				return &v.state
			case 1:
		...
		file_accounts_v1_accounts_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*Error); i {
			case 0:
				return &v.state
			case 1:
		...
		file_accounts_v1_accounts_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*Id); i {
			case 0:
				return &v.state
			case 1:
		...
		file_accounts_v1_accounts_proto_msgTypes[3].Exporter = func(v any, i int) any {
